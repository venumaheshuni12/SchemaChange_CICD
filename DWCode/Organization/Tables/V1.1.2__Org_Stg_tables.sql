...
create table if not exists facilityid_STG (
...
create table if not exists addresslinknum_STG(
	OWNER VARCHAR (22),
...
create table if not exists address_STG (
	ADDRESS_NUM NUMBER (22),
...
create table if not exists phone_link_STG (
	PHONE_NUM NUMBER (30),
...
create table if not exists zipcode_STG (
	CSZ_NUM NUMBER (22),
	ZIPCODE VARCHAR (30),
	CTRY_CODE VARCHAR (8),
